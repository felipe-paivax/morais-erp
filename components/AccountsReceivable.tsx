...
const AccountsReceivable: React.FC<AccountsReceivableProps> = ({
  ...
  }, [accountsReceivable, filterStatus, filterProject]);
  ...
  return (
    <div className="space-y-8 md:space-y-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 md:gap-6">
        ...
        <div className="bg-[#161616] p-6 md:p-8 rounded-[2rem] border border-[#222222]">
          <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-2">Recebidas</p>
        ...
        <div className="bg-[#161616] p-6 md:p-8 rounded-[2rem] border border-[#222222]">
          <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-2">Total Recebido</p>
          ...
          <table className="w-full text-left border-collapse min-w-[800px]">
            <thead>
              <tr className="border-b border-[#222222] bg-[#1a1a1a]/50">
                <th className="px-6 md:px-10 py-4 md:py-6 text-[9px] md:text-[10px] font-black uppercase tracking-widest text-gray-500">Cliente</th>
                  ...
                  return (
                    <tr key={account.id} className="border-b border-[#1A1A1A] hover:bg-white/[0.02] transition-colors group">
                      <td className="px-6 md:px-10 py-6 md:py-8">
                        <p className="text-xs md:text-sm font-black uppercase truncate max-w-[150px]">{client?.name || 'N/A'}</p>
                      </td>
                      <td className="px-6 md:px-10 py-6 md:py-8">
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-xl z-[60] flex items-center justify-center p-4">
          <div className="bg-[#121212] w-full max-w-2xl rounded-[3rem] border border-[#222222] shadow-2xl animate-subtle-fade overflow-y-auto max-h-[90vh]">
            <div className="p-10 border-b border-[#1A1A1A] flex justify-between items-center bg-[#161616]">
              <div>
                <h3 className="text-lg font-black uppercase tracking-tight">Nova Conta a Receber</h3>
            ...
            <div className="p-10 space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-black uppercase text-gray-500 ml-4 tracking-widest">Cliente</label>
                  <select
                    className="w-full p-5 bg-[#1A1A1A] border border-[#222222] rounded-2xl text-white text-xs font-bold focus:border-[#F4C150] outline-none uppercase"
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                <div className="space-y-2">
                  <label className="text-[10px] font-black uppercase text-gray-500 ml-4 tracking-widest">Valor Total (R$)</label>
                  <input
                    type="number"
                    step="0.01"
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-black uppercase text-gray-500 ml-4 tracking-widest">Nº Parcelas</label>
                  <input
                    type="number"
                    min="1"
                    className="w-full p-5 bg-[#1A1A1A] border border-[#222222] rounded-2xl text-white text-xs font-bold focus:border-[#F4C150] outline-none"
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-black uppercase text-gray-500 ml-4 tracking-widest">Valor por Parcela</label>
                  <div className="p-5 bg-[#1A1A1A] border border-[#222222] rounded-2xl text-white text-xs font-bold">
      ...
      {showPaymentModal && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-xl z-[70] flex items-center justify-center p-4">
          <div className="bg-[#121212] w-full max-w-md rounded-[3rem] border border-[#222222] shadow-2xl animate-subtle-fade">
            <div className="p-10 border-b border-[#1A1A1A] flex justify-between items-center bg-[#161616]">
              <div>
                <h3 className="text-lg font-black uppercase tracking-tight">Registrar Recebimento</h3>
            ...
            <div className="p-10 space-y-8">
              <div className="space-y-2">
                <label className="text-[10px] font-black uppercase text-gray-500 ml-4 tracking-widest">Data do Recebimento</label>
                <input
                  type="date"
                  className="w-full p-5 bg-[#1A1A1A] border border-[#222222] rounded-2xl text-white text-xs font-bold focus:border-[#F4C150] outline-none"
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-black uppercase text-gray-500 ml-4 tracking-widest">Método de Recebimento</label>
                <select
                  className="w-full p-5 bg-[#1A1A1A] border border-[#222222] rounded-2xl text-white text-xs font-bold focus:border-[#F4C150] outline-none uppercase"
